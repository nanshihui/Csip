            ...
            switch (whichAction) {
                ...
                case DONT_TAKE_CALL: {
                    if (service != null) {
                        ...
                        System.out.println("我挂喽");
                    }
                    break;
                }
                case REJECT_CALL:
                	System.out.println("我什么都不知道");
              //  break;
                case TERMINATE_CALL: {
                    if (service != null) {
                        service.hangup(call.getCallId(), 0);  //我修改了这里哦
                    	System.out.println("触发了这里哦");
                    //	service.hangup(call.getCallId(), StatusCode.BUSY_HERE);
                    	// service.hangup(call.getCallId(), 487);
