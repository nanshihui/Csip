...
public class CallDetailHistoryAdapter extends BaseAdapter {
    ...
    public CallDetailHistoryAdapter(Context context, LayoutInflater layoutInflater,CallLogBean logbean) {
    	mPhoneCallDetails=null;
    	mContext = context;
        mLayoutInflater = layoutInflater;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
       ...
       else
       {
           ...
           // Set the date.
           CharSequence dateValue = logbean.getDate();
           dateView.setText(dateValue);
           // Set the duration
           if (callType == Calls.MISSED_TYPE) {
               durationView.setVisibility(View.GONE);
               ...
               durationView.setVisibility(View.VISIBLE);
               durationView.setText(formatDuration(logbean.getduration()));
           }
       }
        return result;
    }
